    ...
    let registerHover = () => {
        ...
        context.subscriptions.push(vscode.languages.registerHoverProvider({scheme: 'file'}, {
            provideHover: async (document, position, token) => {
                ...
                let word = trans.word    
                let pre = `**[Google Translate](https://translate.google.com.tr/?sl=auto&tl=${trans.lang.to}&text=${escape(trans.text)})**\n\n`;
        ...
        __hoverBarItem.show();
        __hoverBarItem.text = hoverOpen ? `Vurgulu ceviri: Ac ` : `Vurgulu ceviri: Kapat`;
